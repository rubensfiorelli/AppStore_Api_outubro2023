...
namespace AppStore.Data.Migrations
{
    ...
    [Migration("20231020002258_Build-Token-Service")]
    partial class BuildTokenService
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppStore.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("AppStore.Domain.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppStore.Domain.Entities.User", null)
                        .WithMany()
